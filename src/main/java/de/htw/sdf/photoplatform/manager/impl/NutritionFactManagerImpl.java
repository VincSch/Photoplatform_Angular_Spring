...
public class NutritionFactManagerImpl extends DAOReferenceCollector implements
	...
	private double calculateCalories(double amount, Unit unit,
	...
	private double calculateCarbohydrate(double amount, Unit unit,
			NutritionFact nutrition) {
		double carbohydrate = 0;
	...
	private double calculateFat(double amount, Unit unit,
			NutritionFact nutrition) {
		double fat = 0;
	...
	private double calculateProtein(double amount, Unit unit,
			NutritionFact nutrition) {
		double protein = 0;
