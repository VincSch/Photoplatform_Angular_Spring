...
public class UserController extends BaseAPIController {
    ...
    @ResponseBody
    public void updateUser(@RequestBody UserProfileData userProfileData,
            BindingResult bindingResult) throws AbstractBaseException {
    ...
    @ResponseBody
    public UserProfileData getUserProfileData(@PathVariable String userId)
            throws AbstractBaseException {
